...
# Silhouette
plt.subplot(3, 1, 1)
plt.plot(k_values, silhouette_train_scores,
         marker='o', label="Silhouette Train (KMeans)")
plt.plot(k_values, silhouette_test_scores,
         marker='o', label="Silhouette Test (KMeans)")
plt.plot(k_values, silhouette_train_knn_scores, marker='x',
         label="Silhouette Train (KMeans + KNN)")
plt.plot(k_values, silhouette_test_knn_scores, marker='x',
         label="Silhouette Test (KMeans + KNN)")
...
# Davies-Bouldin
plt.subplot(3, 1, 2)
plt.plot(k_values, db_train_scores, marker='o',
         label="Davies-Bouldin Train (KMeans)")
plt.plot(k_values, db_test_scores, marker='o',
         label="Davies-Bouldin Test (KMeans)")
plt.plot(k_values, db_train_knn_scores, marker='x',
         label="Davies-Bouldin Train (KMeans + KNN)")
plt.plot(k_values, db_test_knn_scores, marker='x',
         label="Davies-Bouldin Test (KMeans + KNN)")
...
plt.plot(k_values, ari_train_knn_scores, marker='x',
         label="ARI Train (KMeans + KNN)")
plt.plot(k_values, ari_test_knn_scores, marker='x',
         label="ARI Test (KMeans + KNN)")
